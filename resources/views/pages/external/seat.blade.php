                ...
                <div class="flex flex-col gap-3 pr-8">
                    @for ($j = 0; $j <25; $j++)
                        ...
                        <div class="flex gap-4">
                            ...
                            @if($j<4)
                                <a @if($i==0) onclick="changeSeat('A{{$j+1}}','first_class')" @else onclick="changeSeat('D{{$j+1}}','first_class')" @endif class="h-8 w-8 cursor-pointer @if(($seats['A'.($j+1)] == 'busy' && $i==0) || ($seats['D'.($j+1)] == 'busy' && $i==1)) @if($ticket->seat == 'A'.($j+1) || 'D'.($j+1)) bg-green-500 @else bg-red-500 @endif  @else bg-sky-200 @endif "></a>
                                <a @if($i==0) onclick="changeSeat('B{{$j+1}}','first_class')" @else onclick="changeSeat('E{{$j+1}}','first_class')" @endif class="h-8 w-8 cursor-pointer @if(($seats['B'.($j+1)] == 'busy' && $i==0) || ($seats['E'.($j+1)] == 'busy' && $i==1)) @if($ticket->seat == 'B'.($j+1) || 'E'.($j+1)) bg-green-500 @else bg-red-500 @endif @else bg-sky-200 @endif"></a>
                                <a @if($i==0) onclick="changeSeat('C{{$j+1}}','first_class')" @else onclick="changeSeat('F{{$j+1}}','first_class')" @endif class="h-8 w-8 cursor-pointer @if(($seats['C'.($j+1)] == 'busy' && $i==0) || ($seats['F'.($j+1)] == 'busy' && $i==1)) @if($ticket->seat == 'C'.($j+1) || 'F'.($j+1)) bg-green-500 @else bg-red-500 @endif @else bg-sky-200 @endif"></a>
                            @else
                                <a @if($i==0) onclick="changeSeat('A{{$j+1}}','economy_class')" @else onclick="changeSeat('D{{$j+1}}','economy_class')" @endif class="h-8 w-8 cursor-pointer @if($j == 4 && $i==0) @if($seats['A'.($j+1)] == 'busy') @if($ticket->seat == 'A'.($j+1) || 'D'.($j+1)) bg-green-500 @else bg-red-500 @endif @else bg-sky-200 @endif @else @if($seats['D'.($j+1)] == 'busy') @if($ticket->seat == 'A'.($j+1) || 'D'.($j+1)) bg-green-500 @else bg-red-500 @endif @else bg-yellow-200 @endif @endif"></a>
                                <a @if($i==0) onclick="changeSeat('B{{$j+1}}','economy_class')" @else onclick="changeSeat('E{{$j+1}}','economy_class')" @endif class="h-8 w-8 cursor-pointer @if(($seats['B'.($j+1)] == 'busy' && $i==0) || ($seats['E'.($j+1)] == 'busy' && $i==1)) @if($ticket->seat == 'B'.($j+1) || 'E'.($j+1)) bg-green-500 @else bg-red-500 @endif @else bg-yellow-200 @endif"></a>
                                <a @if($i==0) onclick="changeSeat('C{{$j+1}}','economy_class')" @else onclick="changeSeat('F{{$j+1}}','economy_class')" @endif class="h-8 w-8 cursor-pointer @if(($seats['C'.($j+1)] == 'busy' && $i==0) || ($seats['F'.($j+1)] == 'busy' && $i==1)) @if($ticket->seat == 'C'.($j+1) || 'F'.($j+1)) bg-green-500 @else bg-red-500 @endif @else bg-yellow-200 @endif"></a>
                            @endif
                    ...
                    @for ($j = 0; $j <32; $j++)
                        ...
                        @if($i==0 || $i==2)
                            <div class="flex gap-4">
                                ...
                                @else
                                    @if($j<6 || ($i==0 && $j==6))
                                        <a @if($i==0) onclick="changeSeat('A{{$j+1}}','first_class')" @else onclick="changeSeat('G{{$j+1}}','first_class')" @endif class="h-8 w-8 cursor-pointer @if(($seats['A'.($j+1)] == 'busy' && $i==0) || ($seats['G'.($j+1)] == 'busy' && $i==2)) @if($ticket->seat == 'A'.($j+1) || 'G'.($j+1)) bg-green-500 @else bg-red-500 @endif @else bg-sky-200 @endif"></a>
                                        <a @if($i==0) onclick="changeSeat('B{{$j+1}}','first_class')" @else onclick="changeSeat('H{{$j+1}}','first_class')" @endif class="h-8 w-8 cursor-pointer @if(($seats['B'.($j+1)] == 'busy' && $i==0) || ($seats['H'.($j+1)] == 'busy' && $i==2)) @if($ticket->seat == 'B'.($j+1) || 'H'.($j+1)) bg-green-500 @else bg-red-500 @endif @else bg-sky-200 @endif"></a>
                                    @else
                                        @if($j == 31)
                                        ...
                                        @else
                                            <a @if($i==0) onclick="changeSeat('A{{$j+1}}','economy_class')" @else onclick="changeSeat('G{{$j+1}}','economy_class')" @endif class="h-8 w-8 cursor-pointer @if(($seats['A'.($j+1)] == 'busy' && $i==0) || ($seats['G'.($j+1)] == 'busy' && $i==2)) @if($ticket->seat == 'A'.($j+1) || 'G'.($j+1)) bg-green-500 @else bg-red-500 @endif @else bg-yellow-200 @endif "></a>
                                            <a @if($i==0) onclick="changeSeat('B{{$j+1}}','economy_class')" @else onclick="changeSeat('H{{$j+1}}','economy_class')" @endif class="h-8 w-8 cursor-pointer @if(($seats['B'.($j+1)] == 'busy' && $i==0) || ($seats['H'.($j+1)] == 'busy' && $i==2)) @if($ticket->seat == 'B'.($j+1) || 'H'.($j+1)) bg-green-500 @else bg-red-500 @endif @else bg-yellow-200 @endif"></a>
                                        @endif
