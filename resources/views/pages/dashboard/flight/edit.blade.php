          ...
          <form method="POST" action="{{route('dashboard.flight.update', $flight->id)}}">
            ...
            <div class="grid grid-cols-2 gap-6">
              ...
              <div class="col-span-2">
                ...
                <input class="mt-1 w-full border border-gray-300 rounded-md p-1 flatpickr-datetime" id="departure_time" name="departure_time" type="text" value="{{old('departure_time', $flight->departure_time)}}" />
