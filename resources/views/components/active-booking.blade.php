      ...
      <div class="col-span-3">
        <div class="m-2 grid grid-cols-5 content-center gap-4 px-4">
          ...
          <div class="rounded-lg bg-slate-200">
            <div class="p-4 tracking-wide">
              ...
              <p class="text-slate-500">{{ $outbound_date }}</p>
            </div>
          </div>
          <!-------------------------------------------------->
          <div class="rounded-lg hover:bg-slate-300">
            <div class="p-4">
              <h1 class="font-semibold">{{ $abbr_departure_city }}</h1>
              <p class="text-slate-500">{{ $departure_city }}</p>
            </div>
          </div>
          <!-------------------------------------------------->
          <div class="rounded-lg hover:bg-slate-300 overflow-hidden">
            <div class="p-4">
              <h1 class="font-semibold">{{ $abbr_arrival_city }}</h1>
              <p class="text-slate-500">{{ $arrival_city }}</p>
            </div>
          </div>
          <!-------------------------------------------------->
        ...
        <div class="m-4 grid grid-cols-5 content-center gap-4 rounded-full px-4 outline outline-1 outline-purple-600 hover:outline-sky-700">
          ...
          <div class="hover:bg-slate-300x max-w-sm rounded-full">
            <div class="p-4 tracking-wide mt-4">
              <div class="flexx items-centerx flex flex-row space-x-10">
                <div class="text-lg font-semibold">{{ $outbound_departure_time }}</div>
              </div>
            </div>
          </div>
          <!-------------------------------------------------->
          <div class="hover:bg-slate-300x rounded-full ">
            <div class="p-4 tracking-wide flex flex-row space-x-10 mt-4">
              <div class="text-lg font-semibold">{{ $outbound_arrival_time }}</div>
            </div>
          </div>
          <!-------------------------------------------------->
          <div class="hover:bg-slate-300x rounded-full">
        ...
        <div class="m-2 grid grid-cols-5 content-center gap-4 px-4">
          ...
          <div class="rounded-lg bg-slate-200">
            <div class="p-4 tracking-wide">
              ...
              <p class="text-slate-500">{{ $inbound_date }}</p>
            </div>
          </div>
          <!-------------------------------------------------->
          <div class="rounded-lg hover:bg-slate-300">
        ...
        <div class="m-4 grid grid-cols-5 content-center gap-4 rounded-full px-4 outline outline-1 outline-purple-600 hover:outline-sky-700">
          ...
          <div class="hover:bg-slate-300x max-w-sm rounded-full">
            <div class="p-4 tracking-wide mt-4">
              <div class="flexx items-centerx flex flex-row space-x-10">
                <div class="text-lg font-semibold">{{ $inbound_departure_time}}</div>
              </div>
            </div>
          </div>
          <!-------------------------------------------------->
          <div class="hover:bg-slate-300x rounded-full ">
            <div class="p-4 tracking-wide flex flex-row space-x-10 mt-4">
              <div class="text-lg font-semibold">{{ $inbound_arrival_time }}</div>
            </div>
          </div>
          <!-------------------------------------------------->
          <div class="hover:bg-slate-300x rounded-full">
