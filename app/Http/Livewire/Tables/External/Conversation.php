...
class Conversation extends LivewireDatatable
{
    ...
    {
        return ModelsConversation::query()->where(['client_id' => Auth()->user()->id]);
    }
        ...
        return [
            ...
            Column::callback(['id', 'status'], function ($id, $status) {
                ...
                $eye = '<div class="flex justify-center">
                            <a href="' . route('external.profile.conversation.show', $id) . '" class="p-1 text-blue-600 hover:text-blue-500 rounded">
